...
export const cursos: Curso[] = [
  ...
  },
  {
    ...
    nome: "Lavanda",
    desc: "Unha de fibra do zero — do preparo ao acabamento.",
    descLonga:
      "Aprenda a fazer uma unha de fibra do absoluto zero: biossegurança, preparação da unha, cutícula, aplicação da fibra, gel construtor, lixamento e acabamento.",
    preco: 5000,
    precoFormatado: "R$ 50,00",
    modulos: 7,
    aulas: 35,
    ...
    corHex: "#CDBCE6",
    paraQuem: [
      "Quem nunca fez unha de fibra e quer começar do absoluto zero",
      "Quem começou e ficou com dúvidas na técnica",
      "Quem quer aprender com segurança e biossegurança correta",
      "Quem sonha em fazer a própria renda com unhas",
    ],
    vaiAprender: [
      "Montar seu kit e trabalhar com biossegurança",
      "Preparar a unha e a cutícula corretamente",
      "Aplicar a fibra no ponto de tensão e construir com gel",
      "Lixar, dar formato e finalizar com acabamento profissional",
    ],
    conteudo: [
      { num: "M0", titulo: "Fundamentos e biossegurança", aulas: 5, gratis: true },
      { num: "M1", titulo: "Preparação da unha natural", aulas: 4 },
      { num: "M2", titulo: "Cutícula essencial", aulas: 5 },
      { num: "M3", titulo: "Aplicação da fibra", aulas: 6 },
      { num: "M4", titulo: "Gel construtor", aulas: 6 },
      { num: "M5", titulo: "Lixamento e formato", aulas: 4 },
      { num: "M6", titulo: "Acabamento", aulas: 4 },
      { num: "B", titulo: "Bônus — guia de brocas", aulas: 3 },
    ],
  },
  {
    slug: "violeta",
    ...
    nome: "Violeta",
    desc: "Aperfeiçoamento — cutilagem avançada e acabamento que dura.",
    descLonga:
      "Refine a sua técnica: cutilagem avançada, o acabamento que faz a unha durar sem arrepiar, correção de erros, reprodução do que a cliente pede e manutenção.",
    preco: 10000,
    precoFormatado: "R$ 100,00",
    modulos: 5,
    aulas: 24,
    ...
    corHex: "#6E5A88",
    paraQuem: [
      "Quem já faz a unha de fibra e quer refinar a técnica",
      "Quem quer que a unha dure semanas sem arrepiar",
      "Quem quer saber corrigir erros com segurança",
      "Quem quer atender pedidos variados das clientes",
    ],
    vaiAprender: [
      "Cutilagem avançada em casos difíceis, com segurança",
      "Os pilares de um acabamento que dura",
      "Corrigir bolhas, descolamento, unha torta e assimetria",
      "Reproduzir formatos, francesinha e decoração + manutenção",
    ],
    conteudo: [
      { num: "M1", titulo: "Cutilagem avançada", aulas: 5, gratis: true },
      { num: "M2", titulo: "Acabamento perfeito que dura", aulas: 5 },
      { num: "M3", titulo: "Corrigindo erros", aulas: 5 },
      { num: "M4", titulo: "Reproduzir o que a cliente pede", aulas: 5 },
      { num: "M5", titulo: "Manutenção (refil)", aulas: 4 },
    ],
  },
  {
    slug: "ametista",
    ...
    descLonga:
      "Transforme a técnica em renda: como precificar, montar portfólio, atrair clientes, fidelizar e organizar o seu negócio de unhas.",
    preco: 15000,
    precoFormatado: "R$ 150,00",
    modulos: 5,
    aulas: 23,
    ...
    corHex: "#3A2450",
    paraQuem: [
      "Quem já sabe fazer e quer viver disso",
      "Quem tem medo de cobrar pelo próprio trabalho",
      "Quem quer atrair e fidelizar clientes",
      "Quem quer organizar o negócio de forma simples",
    ],
    vaiAprender: [
      "Precificar cobrindo material, tempo, custos e lucro",
      "Montar um portfólio bonito só com o celular",
      "Divulgar e conseguir os primeiros clientes",
      "Fidelizar no atendimento e organizar o negócio",
    ],
    conteudo: [
      { num: "M1", titulo: "Quanto cobrar (precificação)", aulas: 4, gratis: true },
      { num: "M2", titulo: "Montando seu portfólio", aulas: 5 },
      { num: "M3", titulo: "Divulgação e primeiros clientes", aulas: 5 },
      { num: "M4", titulo: "Atendimento que fideliza", aulas: 5 },
      { num: "M5", titulo: "Organizando o negócio", aulas: 4 },
    ],
  },
];
...
// Geodo: R$50 + R$100 + R$150 = R$300, 30% off = R$210
export const geodo = {
  slug: "geodo",
  nome: "Geodo",
  nivel: "Coleção completa · Todos os níveis",
  desc: "Os três cursos da linha de unha em um só acesso — Lavanda, Violeta e Ametista.",
  descLonga: "A coleção completa da linha de unha Floreer: da primeira unha ao seu próprio negócio, com acesso vitalício aos três cursos.",
  preco: 21000,
  precoFormatado: "R$ 210,00",
  precoOriginal: "R$ 300,00",
  economia: "R$ 90,00",
  desconto: "30%",
  cor: "#22143A",
  cursosSlugs: ["lavanda", "violeta", "ametista"],
};
